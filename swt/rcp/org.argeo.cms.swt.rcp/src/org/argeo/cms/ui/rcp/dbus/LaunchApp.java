...
/** Launch a FreeDesktop appllication. */
public class LaunchApp {
	private final static Method activateMethod;
	static {
		try {
			// make sure the method is properly referenced
			activateMethod = FreeDesktopApplication.class.getMethod("activate", Map.class);
	...
	public LaunchApp(DBusConnection dBusConnection, String path) {
	...
	public void launch() {
		...
		FreeDesktopApplication app;
		try {
			app = dBusConnection.getRemoteObject(busName, path, FreeDesktopApplication.class);
	...
	public static void main(String[] args) throws Exception {
		...
		BusAddress busAddress = CmsDBus.getSessionBusAddress();
